...
const AgencyNav = ({ current, curNav, onNavigate, NavItem, D, navSearch, otrosOpen, toggleOtros, pal }) => {
  ...
  ), otrosOpen && /* @__PURE__ */ React.createElement("div", { style: { margin: "2px 0 4px", paddingLeft: 8 } }, _NAV_OTROS.map((it, i) => /* @__PURE__ */ React.createElement("div", { key: it.id, style: {
    animation: "pageIn .55s cubic-bezier(0.4,0,0.2,1) both",
