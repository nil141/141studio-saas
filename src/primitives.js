...
const AgencyNav = ({ current, curNav, onNavigate, NavItem, D, navSearch, otrosOpen, toggleOtros, pal }) => {
  ...
  ), otrosOpen && /* @__PURE__ */ React.createElement("div", { style: { marginBottom: 2, animation: "sectionIn .2s ease-out" } }, _NAV_OTROS.map((it) => /* @__PURE__ */ React.createElement(NavItem, { key: it.id, id: it.id, icon: it.icon, label: it.label }))), fp.length > 0 && /* @__PURE__ */ React.createElement("div", { style: { marginTop: 16 } }, /* @__PURE__ */ React.createElement("div", { style: { ..._navSecLabel, color: "var(--accent)" } }, /* @__PURE__ */ React.createElement(Icon, { name: "activity", size: 12, style: { color: "var(--accent)" } }), /* @__PURE__ */ React.createElement("span", null, "En desarrollo activo"), /* @__PURE__ */ React.createElement("span", { style: { color: "var(--accent)", fontWeight: 500, opacity: 0.7 } }, fp.length)), fp.slice(0, 8).map((p, i) => /* @__PURE__ */ React.createElement(
    ListRow,
    {
      key: p.id,
