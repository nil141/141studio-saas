...
const AgencyNav = ({ current, curNav, activePid, onNavigate, NavItem, D, navSearch, otrosOpen, toggleOtros, pal }) => {
  ...
  const outreachDue = (D.OUTREACH || []).filter(
    (o) => o.nextFollowup && o.nextFollowup <= _todayYmd && !["cerrado", "descartado"].includes(o.status) && !o.convertedClientId
  ).length;
...
const Sidebar = ({ current, currentParams, onNavigate, kind = "agency", session, onAssistant, onQuickCreate, onToggleCollapse }) => {
  ...
  const NavItem = ({ id, icon, label, badge, dot, onClick, chevron, active, bare, rowRef, nested, href }) => {
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      dot ? /* @__PURE__ */ React.createElement("span", { style: { position: "absolute", right: 8, top: 7, width: 5, height: 5, borderRadius: 99, background: "var(--accent)" } }) : badge ? /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11, background: "rgba(255,255,255,0.07)", color: "var(--text-muted)", padding: "1px 7px", borderRadius: 99 } }, badge) : null,
...
const NotificationBell = ({ kind, onNavigate }) => {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { position: "relative" }, onClick: (e) => e.stopPropagation() }, /* @__PURE__ */ React.createElement("button", { ref: btnRef, className: "btn ghost icon-only", "aria-label": "Notificaciones", onClick: toggle }, /* @__PURE__ */ React.createElement(Icon, { name: "bell", size: 13 }), unread > 0 && /* @__PURE__ */ React.createElement("span", { style: {
    ...
    placeItems: "center",
    lineHeight: 1
  } }, unread > 9 ? "9+" : unread)), open && ReactDOM.createPortal(
    /* @__PURE__ */ React.createElement(
      "div",
      {
        onClick: (e) => e.stopPropagation(),
