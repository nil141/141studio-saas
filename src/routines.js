  ...
  var RoutineCard = ({ r, day, onEdit, onStep }) => {
    ...
    return /* @__PURE__ */ React.createElement("div", { style: { marginBottom: 28 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 8, marginBottom: 12 } }, /* @__PURE__ */ React.createElement(Icon, { name: "refresh-cw", size: 12, style: { color: "var(--accent)", flexShrink: 0, marginRight: -3 } }), /* @__PURE__ */ React.createElement(
      ...
      return /* @__PURE__ */ React.createElement(
        ...
        )), done ? /* @__PURE__ */ React.createElement(Icon, { name: "check", size: 15, style: { color: "var(--accent)", position: "relative" } }) : pct > 0 ? /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10.5, fontWeight: 400, color: "var(--text-muted)", position: "relative", letterSpacing: "-0.7px" } }, pct, "%") : /* @__PURE__ */ React.createElement(Icon, { name: "x", size: 11, style: { color: "rgba(255,255,255,0.22)", position: "relative" } })),
