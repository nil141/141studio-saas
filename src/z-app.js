(() => {
  ...
  var App = () => {
    ...
    if ((!window.Data.READY || !minSplash) && !loadTimedOut) {
      return /* @__PURE__ */ React.createElement("div", { className: "app-loader" }, /* @__PURE__ */ React.createElement("svg", { className: "lg", viewBox: "0 0 1233.86 193.24", xmlns: "http://www.w3.org/2000/svg" }, /* @__PURE__ */ React.createElement("clipPath", { id: "lgWipe" }, /* @__PURE__ */ React.createElement("rect", { x: "0", y: "193.24", width: "1233.86", height: "0" }, /* @__PURE__ */ React.createElement(
        "animate",
        {
          attributeName: "y",
          from: "193.24",
