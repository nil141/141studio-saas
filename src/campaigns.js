...
const LeadRow = ({ l, last, open, onToggle, onStatus, onDelete, onCopy, onSave, today, selected, onSelectToggle }) => {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { onClick: onToggle, className: "task-row", style: {
    ...
    "button",
    {
      ...
      "data-tooltip": selected ? "Quitar de la selecci\xF3n" : "Seleccionar",
      style: {
        width: 17,
        height: 17,
        borderRadius: 5,
    ...
    selected && /* @__PURE__ */ React.createElement(Icon, { name: "check", size: 11, style: { color: "#fff" } })
...
const CampaignDetail = ({ campaignId, navigate, initialAction }) => {
  ...
  const exportCSV = (list) => {
    ...
    const head = ["Nombre", "Empresa", "Email", "Tel\xE9fono", "Web", "LinkedIn", "Instagram", "Sector", "Estado", "Fecha", "Notas", "Asunto", "Email", "WhatsApp", "Auditor\xEDa"];
    const esc = (v) => {
...
` : "") + (l.draft || "");
  ...
  return /* @__PURE__ */ React.createElement("div", { style: {
  ...
  )))), view === "leads" && selected.size > 0 && /* @__PURE__ */ React.createElement("div", { style: {
    position: "absolute",
    left: "50%",
    bottom: 24,
  ...
  } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 13, color: "var(--text)", letterSpacing: "-0.2px", whiteSpace: "nowrap" } }, /* @__PURE__ */ React.createElement("b", { style: { fontWeight: 600 } }, selected.size), " seleccionado", selected.size === 1 ? "" : "s"), selected.size < visible.length && /* @__PURE__ */ React.createElement(
    "button",
    {
    ...
    letterSpacing: "-0.2px",
    whiteSpace: "nowrap"
  } }, /* @__PURE__ */ React.createElement(Icon, { name: "download", size: 13 }), " Exportar CSV")), csvInput, /* @__PURE__ */ React.createElement(AddLeadModal, { open: addingLead, onClose: () => setAddingLead(false), campaignId: c.id, onDone: reload }), /* @__PURE__ */ React.createElement(CoworkConnectModal, { open: coworkOpen, onClose: () => setCoworkOpen(false), campaignName: c.name }));
};
