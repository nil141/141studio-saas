(() => {
  ...
  const IncomePage = () => {
    ...
    return /* @__PURE__ */ React.createElement("div", { style: {
      ...
      { label: "Base imponible", value: _eur(baseMonth), sub: "este mes \xB7 sin IVA" },
