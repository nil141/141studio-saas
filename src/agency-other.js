      ...
      /* @__PURE__ */ React.createElement("div", { className: "tasks-scroll", style: {
        ...
        return /* @__PURE__ */ React.createElement(
          ...
          (() => {
            ...
            )), isDone ? /* @__PURE__ */ React.createElement(Icon, { name: "check", size: 15, style: { color: "var(--accent)", position: "relative" } }) : prog > 0 ? /* @__PURE__ */ React.createElement("span", { style: { fontSize: 12, fontWeight: 400, color: "var(--text-muted)", position: "relative", letterSpacing: "-0.5px" } }, prog) : /* @__PURE__ */ React.createElement(Icon, { name: "x", size: 11, style: { color: "rgba(255,255,255,0.22)", position: "relative" } }));
          })(),
