(() => {
  ...
  var MiListaBlock = ({ D, navigate, todayStr }) => {
    ...
    return /* @__PURE__ */ React.createElement("section", null, /* @__PURE__ */ React.createElement(
      SectionHead,
      {
        ...
        open,
        onToggle: toggleOpen,
        right: /* @__PURE__ */ React.createElement("button", { className: "section-go", onClick: () => navigate("tasks"), style: { ...LINK_BTN, width: 22, height: 22, color: "var(--text-subtle)" }, title: "Ver todas" }, /* @__PURE__ */ React.createElement(Icon, { name: "arrow", size: 12 }))
      }
  ...
  var EntregasBlock = ({ D, navigate }) => {
    ...
    const arrow = /* @__PURE__ */ React.createElement("button", { className: "section-go", onClick: () => navigate("projects"), style: { ...LINK_BTN, width: 22, height: 22, color: "var(--text-subtle)" }, title: "Ver todos" }, /* @__PURE__ */ React.createElement(Icon, { name: "arrow", size: 12 }));
  ...
  var SeguimientosBlock = ({ D, navigate, mode = "due" }) => {
    ...
    const arrow = /* @__PURE__ */ React.createElement("button", { className: "section-go", onClick: () => navigate("outreach"), style: { ...LINK_BTN, width: 22, height: 22, color: "var(--text-subtle)" }, title: "Ver Outreach" }, /* @__PURE__ */ React.createElement(Icon, { name: "arrow", size: 12 }));
    ...
    const Row = ({ o }) => {
      ...
      if (mode === "due") {
        ...
        const d = daysTo(o.nextFollowup);
        rLabel = d === 1 ? "Ma\xF1ana" : fmt(o.nextFollowup);
        rColor = "var(--text-subtle)";
      }
      return /* @__PURE__ */ React.createElement(
        "div",
        {
