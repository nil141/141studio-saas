(() => {
  ...
  var _BRANDS = [
    ...
    [/google|workspace|gmail|gsuite/, "google.com"],
    [/netflix/, "netflix.com"],
    [/spotify/, "spotify.com"],
    ...
    [/notion/, "notion.so"],
    [/vercel/, "vercel.com"],
    [/openai|chatgpt|\bgpt\b/, "openai.com"],
    [/github/, "github.com"],
    [/gitlab/, "gitlab.com"],
    [/canva/, "canva.com"],
    [/shopify/, "shopify.com"],
    ...
    [/slack/, "slack.com"],
    [/discord/, "discord.com"],
    [/microsoft|office|365|azure/, "microsoft.com"],
    [/apple|icloud/, "apple.com"],
    [/\baws\b|amazon/, "aws.amazon.com"],
    ...
    [/twitch/, "twitch.tv"],
    [/youtube/, "youtube.com"],
    [/meta|facebook|instagram/, "meta.com"],
  ...
  var _brandDomain = (name) => {
    const t = (name || "").toLowerCase();
    for (const [re, d] of _BRANDS) if (re.test(t)) return d;
    return null;
  };
  var BillRow = ({ b, hideMoney, eur, onClick, last }) => {
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { style: {
        ...
        fontWeight: 600,
        fontFamily: "var(--font-display)"
      } }, showLogo ? /* @__PURE__ */ React.createElement(
        "img",
        {
