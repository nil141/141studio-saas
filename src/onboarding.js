...
const OnboardingPage = ({ token }) => {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: {
    ...
    color: "var(--red)",
    fontSize: 12.5
  } }, /* @__PURE__ */ React.createElement(Icon, { name: "alert-triangle", size: 13 }), " ", err || topErr || codeErr)), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 14, marginTop: "auto", paddingTop: 18 } }, /* @__PURE__ */ React.createElement(
    "button",
    {
      type: "button",
      onClick: next,
