...
const CredCatalog = ({ onPick }) => {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "card", style: { marginBottom: 14 } }, /* @__PURE__ */ React.createElement("div", { className: "card-body", style: { padding: 16 } }, /* @__PURE__ */ React.createElement("div", { className: "muted small", style: { marginBottom: 12 } }, "\xBFQu\xE9 acceso quieres a\xF1adir?"), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(150px,1fr))", gap: 10 } }, cat.map((p) => /* @__PURE__ */ React.createElement(
    "button",
    {
      key: p.key,
      onClick: () => onPick(p),
    ...
    /* @__PURE__ */ React.createElement("span", { style: _brandBox }, /* @__PURE__ */ React.createElement(Icon, { name: p.icon, size: 17 })),
    /* @__PURE__ */ React.createElement("span", { style: { minWidth: 0 } }, /* @__PURE__ */ React.createElement("span", { style: { display: "block", fontWeight: 500, fontSize: 13.5, color: "var(--text)" } }, p.name), /* @__PURE__ */ React.createElement("span", { className: "muted xsmall" }, p.mode === "access" ? "Dar acceso" : "Usuario y clave"))
  )))));
};
const CredItem = ({ c, agencyEmail, editable, onDelete }) => {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "card" }, /* @__PURE__ */ React.createElement("div", { className: "card-body", style: { padding: 16 } }, /* @__PURE__ */ React.createElement("div", { className: "row between", style: { alignItems: "flex-start" } }, /* @__PURE__ */ React.createElement("div", { className: "row tight" }, /* @__PURE__ */ React.createElement("span", { style: _brandBox }, /* @__PURE__ */ React.createElement(Icon, { name: meta.icon, size: 16 })), /* @__PURE__ */ React.createElement("div", { style: { fontWeight: 500, fontSize: 14.5 } }, c.label || meta.name)), /* @__PURE__ */ React.createElement("div", { className: "row tight" }, mode === "login" && editable && !editing && /* @__PURE__ */ React.createElement("button", { className: "btn ghost icon-only sm", onClick: () => setEditing(true) }, /* @__PURE__ */ React.createElement(Icon, { name: "edit", size: 13 })), editable && /* @__PURE__ */ React.createElement("button", { className: "btn ghost icon-only sm", onClick: () => onDelete(c) }, /* @__PURE__ */ React.createElement(Icon, { name: "trash", size: 13 })))), mode === "access" ? /* @__PURE__ */ React.createElement("div", { style: { marginTop: 12 } }, /* @__PURE__ */ React.createElement("div", { className: "muted small", style: { lineHeight: 1.5, marginBottom: 8 } }, "Dale acceso a este correo en tu cuenta de ", meta.name, ":"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 8 } }, /* @__PURE__ */ React.createElement("div", { style: { flex: 1, fontSize: 13.5, fontFamily: "var(--font-mono)", wordBreak: "break-all", background: "var(--bg-elev)", border: "0.5px solid var(--border)", borderRadius: 8, padding: "8px 12px" } }, agencyEmail), /* @__PURE__ */ React.createElement("button", { className: "btn ghost icon-only sm", onClick: () => copy(agencyEmail, "mail") }, /* @__PURE__ */ React.createElement(Icon, { name: copied === "mail" ? "check" : "copy", size: 13 }))), editable ? /* @__PURE__ */ React.createElement("button", { className: "btn sm" + (c.granted ? "" : " ghost"), style: { marginTop: 10 }, onClick: () => D.updateCredential(c.id, { granted: !c.granted }) }, c.granted ? /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(Icon, { name: "check", size: 12 }), " Acceso concedido") : "Marcar acceso concedido") : c.granted ? /* @__PURE__ */ React.createElement("div", { style: { marginTop: 10, color: "var(--green)", fontSize: 12.5, display: "inline-flex", alignItems: "center", gap: 5 } }, /* @__PURE__ */ React.createElement(Icon, { name: "check", size: 12 }), " Acceso concedido") : null) : editing ? /* @__PURE__ */ React.createElement("div", { style: { marginTop: 12 } }, /* @__PURE__ */ React.createElement("input", { style: inp, placeholder: "Usuario / email", value: f.username, onChange: (e) => setF((s) => ({ ...s, username: e.target.value })), autoFocus: true }), /* @__PURE__ */ React.createElement("input", { style: inp, placeholder: "Contrase\xF1a", value: f.password, onChange: (e) => setF((s) => ({ ...s, password: e.target.value })) }), /* @__PURE__ */ React.createElement("input", { style: { ...inp, marginBottom: 12 }, placeholder: "Notas (opcional)", value: f.notes, onChange: (e) => setF((s) => ({ ...s, notes: e.target.value })) }), /* @__PURE__ */ React.createElement("div", { className: "row tight" }, /* @__PURE__ */ React.createElement("button", { className: "btn primary sm", onClick: saveEdit }, "Guardar"), /* @__PURE__ */ React.createElement("button", { className: "btn ghost sm", onClick: () => setEditing(false) }, "Cancelar"))) : /* @__PURE__ */ React.createElement("div", { style: { marginTop: 8 } }, c.username && /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 8, marginTop: 6 } }, /* @__PURE__ */ React.createElement("div", { style: { width: 70, fontSize: 12, color: "var(--text-subtle)", flexShrink: 0 } }, "Usuario"), /* @__PURE__ */ React.createElement("div", { style: { flex: 1, fontSize: 13.5, wordBreak: "break-all" } }, c.username), /* @__PURE__ */ React.createElement("button", { className: "btn ghost icon-only sm", onClick: () => copy(c.username, "u") }, /* @__PURE__ */ React.createElement(Icon, { name: copied === "u" ? "check" : "copy", size: 12 }))), c.password && /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 8, marginTop: 6 } }, /* @__PURE__ */ React.createElement("div", { style: { width: 70, fontSize: 12, color: "var(--text-subtle)", flexShrink: 0 } }, "Clave"), /* @__PURE__ */ React.createElement("div", { style: { flex: 1, fontSize: 13.5, fontFamily: "var(--font-mono)", wordBreak: "break-all" } }, show ? c.password : "\u2022\u2022\u2022\u2022\u2022\u2022\u2022\u2022"), /* @__PURE__ */ React.createElement("button", { className: "btn ghost icon-only sm", onClick: () => setShow((s) => !s) }, /* @__PURE__ */ React.createElement(Icon, { name: show ? "eye-off" : "eye", size: 12 })), /* @__PURE__ */ React.createElement("button", { className: "btn ghost icon-only sm", onClick: () => copy(c.password, "p") }, /* @__PURE__ */ React.createElement(Icon, { name: copied === "p" ? "check" : "copy", size: 12 }))), !c.username && !c.password && /* @__PURE__ */ React.createElement("div", { className: "muted small", style: { marginTop: 6 } }, "Sin datos todav\xEDa."), c.notes ? /* @__PURE__ */ React.createElement("div", { className: "muted small", style: { marginTop: 10, lineHeight: 1.5 } }, c.notes) : null)));
};
const ClientCredentials = ({ session }) => {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "page" }, /* @__PURE__ */ React.createElement("div", { className: "page-head" }, /* @__PURE__ */ React.createElement("div", { className: "row between", style: { alignItems: "flex-start", width: "100%" } }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h1", null, "Credenciales"), /* @__PURE__ */ React.createElement("div", { className: "sub" }, "Accesos que compartes con tu agencia. Solo t\xFA y el equipo de 141 pod\xE9is verlos.")), !picking && /* @__PURE__ */ React.createElement("button", { className: "btn primary", onClick: () => setPicking(true) }, /* @__PURE__ */ React.createElement(Icon, { name: "plus", size: 14 }), " A\xF1adir acceso"))), picking && /* @__PURE__ */ React.createElement(CredCatalog, { onPick: add }), creds.length === 0 && !picking ? /* @__PURE__ */ React.createElement(Empty, { icon: "lock", title: "Sin accesos guardados", sub: "A\xF1ade los accesos (redes, web, hosting\u2026) que tu agencia necesita para trabajar." }) : /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(300px,1fr))", gap: 14 } }, creds.map((c) => /* @__PURE__ */ React.createElement(CredItem, { key: c.id, c, agencyEmail, editable: true, onDelete: del }))), /* @__PURE__ */ React.createElement(WhatsAppFloat, null));
};
