  ...
  var AgencyClientDetail = ({ clientId, navigate, openModal }) => {
    ...
    const createPortal = async () => {
      ...
      if (res && res.token) {
        ...
        toast((res == null ? void 0 : res.error) || "Error al generar el portal", "error");
      }
      setPortalBusy(false);
    };
    const copyPortal = () => {
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "page", onClick: () => setMenuOpen(false) }, /* @__PURE__ */ React.createElement("button", { className: "btn ghost sm", style: { marginBottom: 20 }, onClick: () => navigate("clients") }, /* @__PURE__ */ React.createElement(Icon, { name: "chevron", size: 12, style: { transform: "rotate(180deg)" } }), " Clientes"), editing ? /* @__PURE__ */ React.createElement("div", { className: "card", style: { marginBottom: 20 } }, /* @__PURE__ */ React.createElement("div", { className: "card-header" }, /* @__PURE__ */ React.createElement("div", { className: "card-title" }, "Editar cliente"), /* @__PURE__ */ React.createElement("div", { className: "row tight" }, /* @__PURE__ */ React.createElement("button", { className: "btn sm", onClick: cancelEdit }, "Cancelar"), /* @__PURE__ */ React.createElement("button", { className: "btn primary sm", onClick: saveEdit }, /* @__PURE__ */ React.createElement(Icon, { name: "check", size: 12 }), " Guardar cambios"))), /* @__PURE__ */ React.createElement("div", { className: "card-body", style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 } }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: "label" }, "Nombre de contacto"), /* @__PURE__ */ React.createElement("input", { className: "input", ...field("name") })), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: "label" }, "Empresa"), /* @__PURE__ */ React.createElement("input", { className: "input", ...field("company") })), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: "label" }, "Email"), /* @__PURE__ */ React.createElement("input", { className: "input", type: "email", ...field("email") })), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: "label" }, "WhatsApp"), /* @__PURE__ */ React.createElement("input", { className: "input", ...field("whatsapp") })), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: "label" }, "Servicio"), /* @__PURE__ */ React.createElement("input", { className: "input", ...field("service") })), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: "label" }, "Estado"), /* @__PURE__ */ React.createElement("select", { className: "select", ...field("status") }, /* @__PURE__ */ React.createElement("option", { value: "active" }, "Activo"), /* @__PURE__ */ React.createElement("option", { value: "review" }, "En revisi\xF3n"), /* @__PURE__ */ React.createElement("option", { value: "paused" }, "Pausado"))))) : /* @__PURE__ */ React.createElement("div", { className: "card", style: { marginBottom: 20 } }, /* @__PURE__ */ React.createElement("div", { style: { padding: "26px 28px 22px" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", gap: 20, alignItems: "flex-start", flexWrap: "wrap" } }, /* @__PURE__ */ React.createElement("div", { style: { minWidth: 0 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, textTransform: "uppercase", letterSpacing: "0.09em", color: "var(--text-subtle)" } }, [c.service && c.service !== "\u2014" ? c.service : null, projects[0] ? (D.PHASES[projects[0].phase] || {}).label : null].filter(Boolean).join(" \xB7 ") || "Cliente"), /* @__PURE__ */ React.createElement("h1", { style: { fontFamily: "var(--font-display)", fontSize: "clamp(28px,3.4vw,38px)", fontWeight: 400, letterSpacing: "-1.2px", margin: "6px 0 10px" } }, c.company || c.name), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 10, flexWrap: "wrap", color: "var(--text-muted)", fontSize: 13.5 } }, c.name && /* @__PURE__ */ React.createElement("span", null, c.name), c.email && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("span", { style: { opacity: 0.4 } }, "\xB7"), /* @__PURE__ */ React.createElement("span", null, c.email)), c.whatsapp && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("span", { style: { opacity: 0.4 } }, "\xB7"), /* @__PURE__ */ React.createElement("span", null, c.whatsapp)), /* @__PURE__ */ React.createElement(StatusChip, { status: c.status }))), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 6, alignItems: "center", flexShrink: 0 } }, /* @__PURE__ */ React.createElement(
      ...
      setMenuOpen(false);
      removeClient();
    }, style: { display: "flex", alignItems: "center", gap: 8, width: "100%", padding: "7px 10px", border: 0, background: "transparent", color: "var(--red)", fontSize: 13, borderRadius: 6, cursor: "pointer", fontFamily: "inherit" } }, /* @__PURE__ */ React.createElement(Icon, { name: "x", size: 13 }), " Eliminar cliente"))))), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 12, marginTop: 22, flexWrap: "wrap" } }, [
    ...
    ].map((s) => /* @__PURE__ */ React.createElement("div", { key: s.label, style: { padding: "10px 16px", borderRadius: 10, background: "var(--bg-elev-2)", border: "0.5px solid var(--border)", minWidth: 100 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "var(--text-subtle)", marginBottom: 4, fontWeight: 500 } }, s.label), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 18, fontWeight: 600, color: s.color, fontFamily: "var(--font-display)", letterSpacing: "-0.02em" } }, s.value)))))), !editing && /* @__PURE__ */ React.createElement("div", { className: "card", style: {
      padding: "16px 20px",
      marginBottom: 16,
      display: "flex",
      alignItems: "center",
      ...
      return /* @__PURE__ */ React.createElement("div", { key: d.id, className: "card" }, /* @__PURE__ */ React.createElement("div", { style: { aspectRatio: "16/10", background: d.thumb || "linear-gradient(135deg,#1e3a8a,#0f172a)", borderTopLeftRadius: 10, borderTopRightRadius: 10 } }), /* @__PURE__ */ React.createElement("div", { className: "card-body" }, /* @__PURE__ */ React.createElement("div", { className: "row between" }, /* @__PURE__ */ React.createElement("div", { style: { fontWeight: 500, fontSize: 13.5 } }, d.title), d.version && /* @__PURE__ */ React.createElement("span", { className: "chip" }, d.version)), /* @__PURE__ */ React.createElement("div", { className: "subtle xsmall", style: { marginTop: 6 } }, (proj == null ? void 0 : proj.name) || "\u2014", d.date ? " \xB7 " + d.date : ""), /* @__PURE__ */ React.createElement("div", { style: { marginTop: 12 } }, d.status === "approved" ? /* @__PURE__ */ React.createElement("span", { className: "row tight", style: { color: "var(--green)", fontSize: 12.5 } }, /* @__PURE__ */ React.createElement(Icon, { name: "check", size: 13 }), " Aprobado") : /* @__PURE__ */ React.createElement("span", { className: "chip amber", style: { fontSize: 11 } }, "Pendiente de aprobar"))));
    }))), tab === "eventos" && (() => {
      const evs = [];
