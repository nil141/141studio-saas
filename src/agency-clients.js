(() => {
  // src/agency-clients.jsx
  var AgencyClientsList = ({ navigate, openModal }) => {
    const D = window.Data;
    D.useStore();
  ...
  var AgencyClientDetail = ({ clientId, navigate, openModal }) => {
    ...
    const sendNotify = () => {
      ...
      setNotifyOpen(false);
      toast(c.email ? "Aviso a\xF1adido a la bandeja (revisa y env\xEDa abajo)" : "Aviso creado (el cliente no tiene email)", "success");
    };
    const _sectShort = { "client-dashboard": "Inicio", "client-status": "Estado", "client-docs": "Documentaci\xF3n", "client-credentials": "Credenciales" };
    const nInp = {
      width: "100%",
      borderRadius: 9,
      padding: "9px 12px",
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "page", onClick: () => setMenuOpen(false) }, /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11.5, color: "var(--text-subtle)", marginTop: 2, lineHeight: 1.5 } }, "El aviso se a\xF1ade a la bandeja; se enviar\xE1 junto con los dem\xE1s cuando pulses \xABEnviar\xBB.")
    ), /* @__PURE__ */ React.createElement(
      Modal,
      {
        open: outboxOpen,
        onClose: () => setOutboxOpen(false),
        title: "Avisos por enviar",
        sub: c.email ? `Se enviar\xE1 UN correo a ${c.email} con todo lo de abajo` : "El cliente no tiene email; solo ver\xE1 los avisos en su portal",
        footer: /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("button", { className: "btn", onClick: () => {
          D.discardPendingEmails(c.id);
          setOutboxOpen(false);
        } }, "Descartar todo"), /* @__PURE__ */ React.createElement("button", { className: "btn primary", disabled: !pendingAvisos.length, onClick: () => {
          D.sendPendingEmails(c.id);
          setOutboxOpen(false);
        } }, /* @__PURE__ */ React.createElement(Icon, { name: "mail", size: 13 }), " Enviar ", pendingAvisos.length, " en un correo"))
      },
      pendingAvisos.length === 0 ? /* @__PURE__ */ React.createElement("div", { className: "muted small" }, "No hay avisos pendientes.") : /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 10 } }, pendingAvisos.map((it, i) => /* @__PURE__ */ React.createElement("div", { key: i, style: { display: "flex", gap: 10, alignItems: "flex-start", padding: "11px 13px", background: "var(--bg-elev)", border: "0.5px solid var(--border)", borderRadius: 10 } }, /* @__PURE__ */ React.createElement("div", { style: { flex: 1, minWidth: 0 } }, /* @__PURE__ */ React.createElement("div", { style: { fontWeight: 500, fontSize: 13.5 } }, it.title), it.body && /* @__PURE__ */ React.createElement("div", { className: "muted small", style: { marginTop: 2, lineHeight: 1.4 } }, it.body), it.route && /* @__PURE__ */ React.createElement("div", { className: "xsmall muted", style: { marginTop: 4, display: "flex", alignItems: "center", gap: 5 } }, /* @__PURE__ */ React.createElement(Icon, { name: "arrow", size: 10 }), _sectShort[it.route] || "Portal")), /* @__PURE__ */ React.createElement("button", { className: "btn ghost icon-only sm", onClick: () => D.clearPendingEmail(c.id, i) }, /* @__PURE__ */ React.createElement(Icon, { name: "x", size: 12 })))))
    ), /* @__PURE__ */ React.createElement("button", { className: "btn ghost sm", style: { marginBottom: 20 }, onClick: () => navigate("clients") }, /* @__PURE__ */ React.createElement(Icon, { name: "chevron", size: 12, style: { transform: "rotate(180deg)" } }), " Clientes"), pendingAvisos.length > 0 && /* @__PURE__ */ React.createElement("div", { style: {
      display: "flex",
      alignItems: "center",
      gap: 12,
      flexWrap: "wrap",
...
Pedido: factura siempre con CIF en cabecera.` }), /* @__PURE__ */ React.createElement("div", { className: "row", style: { marginTop: 12, justifyContent: "flex-end" } }, /* @__PURE__ */ React.createElement("button", { className: "btn primary sm" }, "Guardar nota")))));
  ...
  var AgencyCredentials = ({ clientId }) => {
    ...
    return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "row between", style: { marginBottom: 14 } }, /* @__PURE__ */ React.createElement("div", { className: "small muted" }, "Accesos del cliente. El cliente tambi\xE9n los ve y edita desde su portal."), !picking && /* @__PURE__ */ React.createElement("button", { className: "btn primary sm", onClick: () => setPicking(true) }, /* @__PURE__ */ React.createElement(Icon, { name: "plus", size: 13 }), " A\xF1adir")), picking && /* @__PURE__ */ React.createElement("div", { className: "card", style: { marginBottom: 14 } }, /* @__PURE__ */ React.createElement("div", { className: "card-body", style: { padding: 16 } }, /* @__PURE__ */ React.createElement("div", { className: "muted small", style: { marginBottom: 12 } }, "\xBFQu\xE9 acceso quieres a\xF1adir?"), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(150px,1fr))", gap: 10 } }, cat.map((p) => /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("span", { style: brand }, /* @__PURE__ */ React.createElement(CredGlyph, { meta: p, size: 16 })),
  ...
  var AgencyDriveFolder = ({ client }) => {
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "card" }, /* @__PURE__ */ React.createElement("div", { className: "card-body", style: { padding: 20 } }, /* @__PURE__ */ React.createElement("div", { className: "row tight", style: { marginBottom: 6 } }, /* @__PURE__ */ React.createElement("div", { style: { width: 24, height: 24, borderRadius: 6, background: "#fff", display: "grid", placeItems: "center" } }, /* @__PURE__ */ React.createElement("svg", { width: "14", height: "14", viewBox: "0 0 24 24" }, /* @__PURE__ */ React.createElement("path", { fill: "#1FA463", d: "M7.71 3.5L1.15 15l3.27 5.5h13.16L21.85 15 14.29 3.5z" }), /* @__PURE__ */ React.createElement("path", { fill: "#FFD041", d: "M7.71 3.5h6.58L21.85 15l-3.27 5.5z", opacity: ".7" }))), /* @__PURE__ */ React.createElement("div", { className: "card-title" }, "Carpeta de Google Drive del cliente")), /* @__PURE__ */ React.createElement("div", { className: "small muted", style: { marginBottom: 14, lineHeight: 1.5 } }, D.driveConfigured ? "La carpeta se crea sola al dar de alta el cliente. Si falta, puedes crearla ahora o pegar el enlace a mano. El cliente ver\xE1 \xABAbrir carpeta en Google Drive\xBB en su portal \u2192 Documentaci\xF3n." : "Pega el enlace de la carpeta compartida. El cliente ver\xE1 el bot\xF3n \xABAbrir carpeta en Google Drive\xBB en su portal \u2192 Documentaci\xF3n. Si lo dejas vac\xEDo, ver\xE1 \xABEstamos preparando la carpeta\xBB."), /* @__PURE__ */ React.createElement("input", { style: inp, placeholder: "https://drive.google.com/drive/folders/\u2026", value: url, onChange: (e) => setUrl(e.target.value) }), /* @__PURE__ */ React.createElement("div", { className: "row tight", style: { marginTop: 10 } }, /* @__PURE__ */ React.createElement("button", { className: "btn primary sm", onClick: save }, "Guardar enlace"), D.driveConfigured && !client.driveUrl && /* @__PURE__ */ React.createElement("button", { className: "btn ghost sm", onClick: () => D.driveCreateFolderForClient(client.id) }, /* @__PURE__ */ React.createElement(Icon, { name: "folder", size: 12 }), " Crear carpeta en Drive"), client.driveUrl && /* @__PURE__ */ React.createElement("a", { className: "btn ghost sm", href: client.driveUrl, target: "_blank", rel: "noreferrer", style: { textDecoration: "none" } }, /* @__PURE__ */ React.createElement(Icon, { name: "external-link", size: 12 }), " Abrir"), saved && /* @__PURE__ */ React.createElement("span", { className: "small", style: { color: "var(--green)" } }, "Guardado \u2713"))));
  };
  var AgencyClientTasks = ({ clientId }) => {
    const D = window.Data;
    D.useStore && D.useStore();
